...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-[#1A1A1A] text-white pt-16 pb-10 px-8 overflow-hidden min-h-[80vh] flex flex-col justify-center">
      
      {/* Background de Imagem (O mesmo do Hero) */}
      <div className="absolute inset-0 z-0">
        <Image
          src="/assets/capa.png"
          alt="Background Footer"
          fill
          className="object-cover brightness-[0.25] grayscale-[0.5]" // Ajustado para ser levemente mais escuro que o Hero para dar leitura
        />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full">
        ...
        <div className="flex flex-col items-center gap-10 md:gap-12">
          ...
          <a 
            ...
            className="group flex items-center gap-3 bg-white/10 backdrop-blur-md hover:bg-white/20 text-white px-8 py-4 rounded-full font-sans font-bold text-[10px] md:text-xs uppercase tracking-[0.2em] transition-all duration-300 shadow-xl active:scale-95 border border-white/20"
          >
            <svg 
          ...
          <div className="w-full pt-10 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6 text-center md:text-left">
