  ...
  return (
    <section className="relative min-h-screen bg-[#F5F5F5] flex flex-col items-center py-16 md:py-24 px-8 md:px-24 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <div className="space-y-8 z-10 order-2 lg:order-1 text-center lg:text-left text-[#1A1A1A]">
          <header>
          ...
          <div className="pt-8 border-t border-black/10 text-[#1A1A1A]">
            ...
            <ul className="space-y-3 font-sans text-base opacity-90 text-[#1A1A1A] text-left inline-block lg:block">
              ...
              <li>• 1.000 forminhas de doces em tecido luxo</li>
              <li>• 150 bem-vividos personalizados</li>
            </ul>
          </div>
        </div>
