  ...
  return (
    <section className="relative min-h-screen bg-[#F5F5F5] flex flex-col items-center py-16 md:py-24 px-8 md:px-24 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        {/* Coluna da Esquerda: Texto e Composição */}
        <div className="space-y-8 z-10 order-2 lg:order-1">
          <header>
            ...
            <div className="space-y-4 font-sans text-lg md:text-xl leading-relaxed opacity-90 text-pretty">
              <p>
          ...
          <div className="pt-8 border-t border-black/10">
            ...
            <ul className="space-y-3 font-sans text-base opacity-80">
        ...
        {/* Coluna da Direita: Espaço para sua Imagem */}
